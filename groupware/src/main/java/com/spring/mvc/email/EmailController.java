...
//						
			...
			System.out.println(pagenum+","+contentnum);
...
//					
			...
			List<DtoEmail> dto = dao.listTrashMail(member_id ,pagemaker.getPagenum()*10+1,pagemaker.getContentnum()*(pagemaker.getPagenum()+1));
			if(dto.isEmpty()) {
...
//					
			...
			List<DtoEmail> dto = dao.listSaveMail(member_id,pagemaker.getPagenum()*10+1,pagemaker.getContentnum()*(pagemaker.getPagenum()+1));
			if(dto.isEmpty()) {
