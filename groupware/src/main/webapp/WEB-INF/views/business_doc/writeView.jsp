...
<div class="container">
		...
		<table class =" table table-striped" style="text-align: center; border: 1px solid #dddddd">
			<tr>
				<td>작성자</td>
				<td  style="text-align: left;" name="member_id" ><%=dto.getMember_name()%></td>
			</tr>
			<tr>
				<td>기안서 제목</td>
				
				<td  style="text-align: left;" name="drafting_title" ><%=dto.getBusiness_title()%></td>
			</tr>
			<tr>
				<td>작성일</td>
			...
			<td colspan="2"><textarea  rows="25" cols ="170"style="background-color: #f9f9f9;  border:none;class="form-control" readonly rows="20" name = drafting_content><%= dto.getBusiness_content() %></textarea></td>
		</tr>
